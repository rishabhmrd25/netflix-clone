    ...
    <div>
      ...
      >
        <div className="grid content-center justify-center h-full justify-items-center">
          {plan && (
            <Fade duration={2000}>
              <div className="text-white text-3xl mb-20 border-2 border-red-500 p-4 rounded-md">
              Your plan: <span className="text-red-500">{plan}</span> has been subscribed successfully
              </div>
              </Fade>
          )}
